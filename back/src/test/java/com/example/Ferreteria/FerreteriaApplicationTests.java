...
*/
    ...
    void testGetClientesSuccessUnitario() throws Exception {
        ...
        //clienteService.saveClient(clienteModel);
        ...
        //clienteService.saveClient(clienteModel1);

        List<ClienteModel> clientes = List.of(clienteModel, clienteModel1);
 ...
 */
    ...
    void testGetVendedoresSuccess() throws Exception {
        ...
        List<VendedorModel> vendedores = List.of(vendendorModel, vendedorModel1);
